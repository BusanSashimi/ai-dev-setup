...
- **기준 폴더**: `webapp/src/modules/test/pages/select-list/` 및 `webapp/src/modules/test/modals/` 폴더의 구조를 **반드시** 그대로 따름
...
- **기준 코드:** 모든 파일은 `webapp/src/modules/test/pages/select-list/` 및 `webapp/src/modules/test/modals/` 폴더의 파일을 기준으로 작성합니다.
...
- **기준 폴더**: `webapp/src/modules/test/pages/select-list/` (demo.vue) 및 `webapp/src/modules/test/modals/` ([모듈명]-select.modal.vue) 기준
